...
import pdfsInfo from './pdfsInfo.js'; // Relative path to your File
...
class home extends Component {
  ...
  listPdfs = () => {
    console.log("Requesting pdf list from server...")
  ...
  openPdf = (name) => {
    ...
    this.setState({'msgVariant':'warning', 'msgText':"Selected file: '" + name + ".pdf', processing...", 'extraMsg':"Status: Initialising process..."});
  ...
  onDrop = (files) => {
    ...
    this.setState({'msgVariant':'warning', 'msgText':"Received file: '" + filename + "', processing...", 'extraMsg':"Status: Initialising process..."});
    ...
    <div>
      ...
      <PDFtoIMG file={this.state.file}>
          {({pages}) => {
              ...
              this.state.numPages = pages.length;
              return <div>
                <img src={pages[this.state.currentPageNumber - 1]}>
                </img>
              </div>
